...
// Prefilled message — must be URI-encoded
const WA_NUMBER  = '254710473244';
const WA_MESSAGE = encodeURIComponent(
  'Hello Kanyanjua, I would like to learn more about your consulting services.'
);
...
export default function WhatsappFloat() {
  return (
    <a
      ...
      aria-label="Chat with Kanyanjua on WhatsApp"
    >
      ...
      >
        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94
          ...
          11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882
